...
public class DetalleTipoTramitesController {


    public BorderPane bdp_dettipotramites;
    public HBox vbx_menu;
    public Button btn_ver;
    public Button btn_modificar;
    public Button btn_agregar;
    public AnchorPane acp_dettipotramites;
    public Button btn_guardar;
    public Label txt_fecmofificacion;
    public Label txt_fecregistro;
    public ComboBox cbx_estado;
    public TextField txt_descrpcion;
